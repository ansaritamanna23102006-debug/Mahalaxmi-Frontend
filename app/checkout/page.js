    ...
    <div className="bg-brand-bg text-brand-text min-h-screen">
      ...
      <section className="pt-32 pb-12 bg-brand-brown text-brand-cream relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 space-y-2">
          ...
          <h1 className="font-playfair text-3xl md:text-5xl font-black">Secure Checkout</h1>
      ...
      {/* Steps Indicator */}
      {step < 5 && (
        <section className="py-6 bg-brand-cream border-b border-brand-gold/15">
          <div className="max-w-3xl mx-auto px-4 flex items-center justify-between text-xs sm:text-sm font-poppins font-bold uppercase tracking-wider text-brand-brown">
            {[
              ...
              <div key={s.num} className="flex items-center gap-2">
                <span className={`w-8 h-8 rounded-full flex items-center justify-center text-xs border ${step >= s.num ? 'bg-brand-maroon text-brand-cream border-brand-maroon' : 'bg-white border-brand-gold/25 text-brand-text/50'}`}>
                  {step > s.num ? <Check className="w-4 h-4" /> : s.num}
                </span>
                <span className={step === s.num ? 'text-brand-maroon underline' : 'text-brand-brown/50 hidden sm:inline'}>{s.label}</span>
              </div>
            ))}
          </div>
        </section>
      ...
      <section className="py-16 max-w-5xl mx-auto px-4 md:px-8">
        ...
        {step === 5 ? (
          // Success Screen
          <div className="text-center py-20 bg-white border border-brand-gold/15 rounded-[36px] space-y-6 max-w-2xl mx-auto">
            <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center text-green-600 mx-auto border-2 border-green-300">
            ...
            <p className="text-xs sm:text-sm font-poppins text-brand-text/80 leading-relaxed max-w-md mx-auto">
              Thank you for ordering from Mahalaxmi Mithaiwala since 1982. Your order code is <strong className="text-brand-maroon font-bold font-mono">{placedOrderId}</strong>. We have sent receipt details to your registered credentials.
            </p>
            ...
            <div className="flex justify-center gap-4 pt-4">
              ...
              <a 
                href="/sweets" 
                className="bg-brand-maroon hover:bg-brand-gold text-brand-cream hover:text-brand-brown px-6 py-3 rounded-xl text-xs font-bold font-poppins transition-colors shadow-sm"
              >
                Continue Shopping
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            {/* Step Panel */}
            <main className="lg:col-span-8 bg-white p-8 rounded-[36px] border border-brand-gold/15 shadow-sm space-y-6">
              ...
              {step === 1 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input 
                        ...
                        className="w-full px-4 py-2.5 bg-brand-bg rounded-xl border border-brand-gold/20 text-xs sm:text-sm focus:outline-none focus:ring-1 focus:ring-brand-gold font-poppins"
                      />
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-brand-brown">Mobile Phone</label>
                      <input 
                        type="tel" 
                        required
                        value={address.phone}
                    ...
                    {!isLoggedIn && (
                      <div className="space-y-1 sm:col-span-2">
                        <label className="text-xs font-bold uppercase tracking-wider text-brand-brown">Email Address (For invoice & order updates)</label>
                        <input 
                          type="email" 
                          required
                          value={address.email}
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-bold uppercase tracking-wider text-brand-brown">Street Address</label>
                    <input 
                      type="text" 
                      required
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-brand-brown">Landmark</label>
                      <input 
                        type="text" 
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-brand-brown">Pin Code</label>
                      <input 
                        type="text" 
                        required
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-bold uppercase tracking-wider text-brand-brown">City</label>
                      <input 
                        type="text" 
                        disabled
                        value={address.city}
                        className="w-full px-4 py-2.5 bg-brand-bg/60 text-brand-brown/50 rounded-xl border border-brand-gold/20 text-xs sm:text-sm font-poppins"
                      />
                    </div>
                  </div>
                </div>
              ...
              {step === 2 && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <label className="flex items-center gap-4 p-4 rounded-xl border border-brand-gold/20 hover:bg-brand-bg cursor-pointer transition-colors">
                      <input 
                        type="radio" 
                        name="delivery" 
                        value="standard" 
                        ...
                        className="accent-brand-maroon w-4.5 h-4.5"
                      />
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      <label 
                        key={pm.id} 
                        className={`flex items-center gap-3 p-4 rounded-xl border cursor-pointer transition-all ${paymentMethod === pm.id ? 'border-brand-maroon bg-brand-maroon/5 text-brand-maroon' : 'border-brand-gold/25 hover:bg-brand-bg'}`}
                      >
                        <input 
                          type="radio" 
                          name="payment" 
              ...
              {step === 4 && (
                <div className="space-y-6">
                  ...
                  <div className="p-5 rounded-2xl bg-brand-cream border border-brand-gold/15 space-y-3 font-poppins text-xs sm:text-sm">
                    ...
                    <p className="text-brand-text/80 font-semibold uppercase pt-2 border-t border-brand-gold/10">Method: {deliveryMethod.toUpperCase()}</p>
                    <p className="text-brand-text/80 font-semibold uppercase">Payment: {paymentMethod.toUpperCase()}</p>
                  </div>

                  <div className="space-y-4">
                    <h4 className="font-playfair text-lg font-bold text-brand-brown">Items:</h4>
                    {cart.map((item, idx) => (
                      <div key={idx} className="flex justify-between items-center text-xs sm:text-sm font-poppins">
              ...
              <div className="flex justify-between items-center pt-6 border-t border-brand-gold/10">
                {step > 1 ? (
                  <button 
                    onClick={handlePrevStep}
                    className="border border-brand-gold/30 hover:bg-brand-bg text-brand-brown font-bold font-poppins px-6 py-2.5 rounded-xl text-xs transition-colors"
                  >
                    Back
                  </button>
                ) : (
                ...
                <button 
                  ...
                  className="bg-brand-maroon hover:bg-brand-gold text-brand-cream hover:text-brand-brown font-bold font-poppins px-8 py-3 rounded-xl text-xs transition-all duration-300 shadow-md flex items-center gap-2 active:scale-95"
                >
            ...
            <aside className="lg:col-span-4 bg-brand-brown text-brand-cream p-8 rounded-[36px] border border-brand-gold/20 shadow-md space-y-6">
              <h3 className="font-playfair text-xl font-bold text-white">Your Order</h3>
              <div className="w-12 h-[2px] bg-brand-gold"></div>
